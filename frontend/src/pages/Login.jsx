        ...
        <div className="relative z-10 flex flex-col justify-between h-full px-8 py-10 sm:px-14 sm:py-14 lg:min-h-screen">
          ...
          <div className="mt-16 lg:mt-0 max-w-md mb-16 lg:mb-0">
            ...
            <p className="mt-5 text-[15px] leading-relaxed text-[#c2c6d4]">
              Sign back in to pick up your applications, listings, and
              conversations right where you left them.
            </p>
          </div>
          ...
          <form className="space-y-5">
            ...
            <div>
              <div className="mb-1.5 flex items-center justify-between">
                <label
                  htmlFor="password"
                  className="block text-sm font-medium text-[#333a52]"
                >
                  Password
                </label>
                <a
                  href="#"
                  className="text-xs font-medium text-[#6b7186] underline underline-offset-2 hover:text-[#0d0f17]"
                >
                  Forgot password?
                </a>
              </div>
            ...
            <label className="flex items-center gap-2.5 pt-1 select-none">
              <input
                type="checkbox"
                className="h-4 w-4 rounded border-[#c2c6d4] text-[#0d0f17] focus:ring-2 focus:ring-[#0d0f17]/15"
              />
              <span className="text-sm text-[#333a52]">Keep me signed in</span>
            </label>
